...
const LandingTopSection = () => {
    ...
    return (
        <Flex data-aos="zoom-in-right" data-aos-delay="200" flexDir={"column"} w={["100%", "100%", "85%", "75%", "70%"]} m="auto" mt={["30px", "30px", "80px", "80px", "80px"]} pt="95px" justifyContent="center" >
            ...
            <Flex flexDir={"row"} w={["50%", "50%", "20%", "50%", "20%"]} bg="#077BFF" justifyContent={"center"} py="12.5px" alignItems={"center"} borderRadius={"10px"} m="auto" mt="20px" onClick={() => naviagte("/checker")} cursor="pointer" boxShadow={"0px 5px 0px #0566d4"}  >
            ...
            <Flex flexDir={"column"} w={["50%", "50%", "20%", "50%", "20%"]} bg="rgba(0, 182, 122, 0.1)" justifyContent={"center"} pt="20.2px" pb="10px" alignItems={"center"} borderRadius={"10px"} m="auto" mt="20px"  >
                <Flex flexDir={"row"} >
