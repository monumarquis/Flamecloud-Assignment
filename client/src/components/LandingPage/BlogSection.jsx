...
const BlogSection = () => {
    ...
    return (
        <Flex flexDir={"column"} w="100%" justifyContent="center" mb="120px" >
            <Text data-aos="flip-left" color="#111822" mb="10px" fontWeight={"600"} textAlign="center" fontSize={["24px", "24px", "36px", "36px", "36px"]} lineHeight={["32.2px", "32.2px", "43.2px", "43.2px", "43.2px"]} >Read our <span style={{ color: "#077BFF" }} >Exclusive</span> Blog</Text>
            ...
            {/* 6 blogs */}
            <SimpleGrid px="40px" display={["none", "none", "grid", "grid", "grid"]} columns={[1, 1, 2, 2, 3]} rowGap={["38px", "38px", "38px", "38px", "38px"]} columnGap={["25px", "25px", "25px", "25px", "25px"]} w="70%" m="auto" >
                {
                    blogArray.map((el, i) => {
                        return (
            ...
            {/* 4 blogs */}
            <SimpleGrid px="40px" display={["grid", "grid", "none", "none", "none"]} columns={[2, 2, 2, 2, 3]} rowGap={["38px", "38px", "38px", "38px", "38px"]} columnGap={["10px", "10px", "25px", "25px", "25px"]} w={["100%","100%","70%","70%","70%","70%"]} m="auto" >
                {
                    blogArray2.map(() => {
                        return (
                            <Flex flexDir={"column"} >
