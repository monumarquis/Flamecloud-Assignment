...
const BlogSection = () => {
    ...
    return (
        <Flex flexDir={"column"} w="100%" px={["0", '0', "2", "9", "9"]} justifyContent="center" mb="120px" >
            ...
            <Text data-aos="flip-left" color="#111822" opacity="0.5" fontWeight={"500"} w={["78%", "78%", "70%", "50%", "40%"]} textAlign="center" fontSize={["13px", "13px", "18px", "18px", "18px"]} m="auto" lineHeight={["15.2px", "15.2px", "21.2px", "21.2px", "21.2px"]} >Lorem ipsum dolor sit amet, consectetur adipiscing elit. In luctus augue sit amet mollis molestie.</Text>
