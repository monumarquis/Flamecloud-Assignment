    ...
    return (
        <Flex flexDir={"column"} w="100%" justifyContent="center" mb="120px" >
            <Flex flexDir="column" border="1px solid rgba(30, 30, 30, 0.1)" borderRadius={"5px"} bg="linear-gradient(180deg, #F7FAFF 0%, rgba(255, 255, 255, 0) 100%)" w={["100%", "100%", "80%", "80%", "80%"]} m="auto"  >
                <Text data-aos="flip-left" color="#111822" mb={["3px", "3px", "10px", "10px", "10px"]} fontWeight={"600"} textAlign="center" fontSize={["24px", "24px", "36px", "36px", "36px"]} mt={["30px","30px","60px","60px","60px"]} lineHeight={["32.2px", "32.2px", "43.2px", "43.2px", "43.2px"]} >Read our <span style={{ color: "#077BFF" }} >Exclusive</span> Blog</Text>
