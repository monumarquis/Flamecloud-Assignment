...
const CustomerSection = () => {
    ...
    return (
        <Flex flexDir={"column"} w="100%" px={["9", '9', "9", "9", "9"]} mb={["110px", "110px", "250px", "250px", "250px"]} >
            ...
            <Text data-aos="flip-left" color="#111822" opacity="0.5" fontWeight={"500"} w={["98%", "98%", "70%", "50%", "40%"]} textAlign="center" fontSize={["15px", "15px", "18px", "18px", "18px"]} m="auto" lineHeight={["15.2px", "15.2px", "21.2px", "21.2px", "21.2px"]} >Lorem ipsum dolor sit amet, consectetur adipiscing elit. In luctus augue sit amet mollis molestie.</Text>
            <SimpleGrid mt="34px" columns={[1, 1, 2, 2, 3]} spacing={["28px", "28px", "10px", "18px", "18px"]}  >
                {
                    customerlove.map((el, i) => {
                        return (
                            <Flex data-aos="zoom-in" data-aos-delay={(i + 1) * 100} flexDir={"column"} py='28px' px={["15.8px", "15.8px", "25.8px", "25.8px", "25.8px"]} background={"rgba(30, 30, 30, 0.01)"} borderRadius="5px" border="1px solid rgba(22, 209, 19, 0.5)" >
