          ...
          <Table >
            <Thead  border={" 1px solid rgba(0, 0, 0, 0.25)"} bg="rgba(0, 0, 0, 0.1)">
              <Tr border={" 1px solid rgba(0, 0, 0, 0.25)"} >
                <Th borderBottom={" 1px solid rgba(0, 0, 0, 0.25)"} p={[2, 2, 4, 4, 4]} fontSize={["12px", "12px", "14px", "14px", "14px"]} fontWeight="600" lineHeight={"16.8px"} opacity="0.6" color="#111822" >IP</Th>
                <Th borderBottom={" 1px solid rgba(0, 0, 0, 0.25)"} p={[2, 2, 4, 4, 4]} fontSize={["12px", "12px", "14px", "14px", "14px"]} fontWeight="600" lineHeight={"16.8px"} opacity="0.6" color="#111822">PROXY</Th>
                <Th borderBottom={" 1px solid rgba(0, 0, 0, 0.25)"} p={[2, 2, 4, 4, 4]} fontSize={["12px", "12px", "14px", "14px", "14px"]} fontWeight="600" lineHeight={"16.8px"} opacity="0.6" color="#111822">CITY</Th>
                <Th borderBottom={" 1px solid rgba(0, 0, 0, 0.25)"} p={[2, 2, 4, 4, 4]} fontSize={["12px", "12px", "14px", "14px", "14px"]} fontWeight="600" lineHeight={"16.8px"} opacity="0.6" color="#111822">COUNTRY</Th>
              </Tr>
            </Thead>
                ...
                tableData.map((el) => {
                  return (
                    <Tr  bg="rgba(217, 216, 214, 0.05)" borderRadius={"5px"} >
                      <Td borderBottom={" 1px solid rgba(0, 0, 0, 0.25)"} p={[2, 2, 3, 3, 4]} fontSize={["12px", "12px", "14px", "14px", "14px"]} fontWeight="500" lineHeight={"16.8px"} color="#111822">{el.ip}</Td>
                      <Td borderBottom={" 1px solid rgba(0, 0, 0, 0.25)"} p={[2, 2, 3, 3, 4]} fontSize={["12px", "12px", "14px", "14px", "14px"]} fontWeight="500" lineHeight={"16.8px"} color="#111822">{el.proxy}</Td>
                      <Td borderBottom={" 1px solid rgba(0, 0, 0, 0.25)"} p={[2, 2, 3, 3, 4]} fontSize={["12px", "12px", "14px", "14px", "14px"]} fontWeight="500" lineHeight={"16.8px"} color="#111822">{el.city}</Td>
                      <Td borderBottom={" 1px solid rgba(0, 0, 0, 0.25)"} p={[2, 2, 3, 3, 4]} fontSize={["12px", "12px", "14px", "14px", "14px"]} fontWeight="500" lineHeight={"16.8px"} color="#111822">{el.country}</Td>
                    </Tr>
