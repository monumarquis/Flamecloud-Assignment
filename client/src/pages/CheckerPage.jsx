...
const CheckerPage = () => {
  return (
    <Flex w="100%" flexDir={"column"}>
      {/* Ist section */}
      <Flex mt="40px" flexDir={"column"} pb="42px" w={["100%", "100%", "85%", "75%", "65%"]} m="auto" pt="95px" justifyContent="center" px={["5", '5', "9", "9", "9"]} >
      ...
      <Flex flexDir={"column"} pb="42px" w={["100%", "100%", "85%", "75%", "60%"]} m="auto" pt="42px" justifyContent="center" px={["5", '5', "9", "9", "9"]} >
        <Flex mb="21px" flexDir={"column"} h="169px" p="19px" bg="rgba(217, 216, 214, 0.25)" border={"1px solid rgba(0, 0, 0, 0.25)"} borderRadius="5px" >
        ...
        <Flex flexDir={["column","column","row","row","row"]} justifyContent="space-between" mb="51px"   >
          <Flex borderRadius={"5px"} w={"200px"} bg="#077BFF" alignItems={"center"} justifyContent="center" py="10px" mb={["10px","10px","0px","0px","0px"]} >
            <Text color="#FFFFFF" fontSize={["15px","15px","16px","16px","16px"]} fontWeight="600" lineHeight={"19.2px"}  >Check Location</Text>
          </Flex>
          <Text color="#111822" w={["100%","100%","225px","225px","225px"]} opacity={"0.5"} fontSize={["12px","12px","14px","14px","14px"]} fontWeight="400" lineHeight={"16.8px"} >
            <Highlight
        ...
        <Text color="#077BFF" mb="17px" fontWeight={"500"} fontSize={["20px", "20px", "20px", "20px", "20px"]} lineHeight={["24px", "24px", "24px", "24px", "24px"]} >Your Results</Text>
        {/* table section */}
        <TableContainer background={"rgba(217, 216, 214, 0.05)"} borderRadius="5px" border="1px solid rgba(0, 0, 0, 0.25)" w="100%" >
          <Table >
