...
const CheckerPage = () => {
  ...
  return (
    <Flex w="100%" flexDir={"column"}>
      {/* Ist section */}
      <Flex data-aos="zoom-in-right" data-aos-delay="200" flexDir={"column"} pb="42px" w={["80%", "80%", "85%", "75%", "60%"]} m="auto" mt="80px" pt="95px" justifyContent="center"  >
      ...
      {/* 2nd section */}
      <Flex flexDir={"column"} pb="42px" w={["80%", "80%", "85%", "75%", "60%"]} m="auto" pt="42px" justifyContent="center"  >
        ...
        <Flex data-aos="flip-right" flexDir={["column", "column", "row", "row", "row"]} justifyContent="space-between" mb="51px"   >
