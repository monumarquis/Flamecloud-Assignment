...
const Footer = () => {
    ...
    return (
        <Flex w="100%"  >
            <Flex w={"100%"} flexDir={["column", "column", "column", "row", "row"]} px={["2", '2', "5", "5", "5"]} py="40px" m="auto" borderTop="1px solid #D9D8D6">
                {/* left side */}
                <Flex flexDir={["row", "row", "row", "column", "column"]} w={["95%", "95%", "95%", "20%", "16%"]} mr={["300px", "300px", "300px", "180px", "300px"]} justifyContent="space-between" >
                ...
                {/* Right Side */}
                <SimpleGrid columns={3} spacing={["20px", "20px", "20px", "40px", "100px"]} mt={["20px", "20px", "20px", "0px", "0px"]} ml={["7px", "7px", "0px", "0px", "0px"]} >
                    <Flex flexDir={"column"} >
                        <Text mb="13px" color={"#969493"} fontSize="12px" fontWeight={"400"} lineHeight="16.8px" >Explore</Text>
                    ...
                    <Flex flexDir={"column"} >
                        <Text mb="13px" color={"#969493"} fontSize="12px" fontWeight={"400"} lineHeight="16.8px" >Resources</Text>
